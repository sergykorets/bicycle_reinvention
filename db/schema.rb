...
ActiveRecord::Schema.define(version: 20170801141512) do
  ...
  create_table "bicycles", force: :cascade do |t|
    ...
    t.index ["author_id"], name: "index_bicycles_on_author_id", using: :btree
    t.index ["category_id"], name: "index_bicycles_on_category_id", using: :btree
    t.index ["slug"], name: "index_bicycles_on_slug", unique: true, using: :btree
  end
